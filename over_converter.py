...
def filter_csv_by_ball_count(input_csv, output_csv, max_balls):
    ...
    df_innings1['GlobalBall'] = (df_innings1['Over'] - 1) * 6 + df_innings1['Ball']
...
if __name__ == '__main__':
    ...
    filter_csv_by_ball_count(input_csv, 'over1.csv', 6)   # First over (6 balls)
    filter_csv_by_ball_count(input_csv, 'over5.csv', 30)  # First 5 overs (30 balls)
    filter_csv_by_ball_count(input_csv, 'over10.csv', 60)  # First 6 overs (36 balls)
